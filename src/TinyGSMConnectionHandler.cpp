...
/******************************************************************************
  CTOR/DTOR
 ******************************************************************************/
TinyGSMConnectionHandler::TinyGSMConnectionHandler()
: ConnectionHandler(true, NetworkAdapter::GSM) {}

TinyGSMConnectionHandler::TinyGSMConnectionHandler(const char * pin, const char * apn, const char * login, const char * pass, bool const keep_alive)
...
unsigned long TinyGSMConnectionHandler::getTime()
{
  return _gsm.getTime();
}
...
NetworkConnectionState TinyGSMConnectionHandler::update_handleInit()
{
...
NetworkConnectionState TinyGSMConnectionHandler::update_handleConnecting()
{
...
NetworkConnectionState TinyGSMConnectionHandler::update_handleConnected()
{
...
NetworkConnectionState TinyGSMConnectionHandler::update_handleDisconnecting()
{
  _gsm.shutdown();
  return NetworkConnectionState::DISCONNECTED;
}

NetworkConnectionState TinyGSMConnectionHandler::update_handleDisconnected()
{
  if (_keep_alive)
  {
...
#endif /* #ifdef BOARD_HAS_TINY_GSM  */